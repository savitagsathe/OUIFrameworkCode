...
public class ProductInfoPage {
	...
	private By priceMetaData=By.xpath(" (//div[@id= 'content']//ul[@class='list-unstyled'])[position()=1]//li");
...
private void getProdPriceMtaData(Map<String, String> prodMap) {
		
	List<WebElement>priceList=elementUtil.getElements(priceMetaData);
